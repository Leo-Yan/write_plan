...
We can recall the previous section was absent to show how the perf tool is
waken up in the test, the scheduler tracepoints can help us to easily
understand scheduling behaviours. By enabling the tracepoints, we get below
logs:
...
user space respectively. The later sections will demonstrate how to use them.
