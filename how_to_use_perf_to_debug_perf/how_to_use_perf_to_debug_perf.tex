...
perf is not linked with libtraceevent, to use the new probe you can use tracefs:
	...
	echo 1 > tracing_on
	cat trace_pipe
	Before removing the probe, echo 0 > events/probe/perf_aux_output_end_L31/enable
\end{lstlisting}

\subsubsection*{Adding a probe in the perf}

The rest thing is to apply the same steps for adding probe in the perf tool.
...
perf is not linked with libtraceevent, to use the new probe you can use tracefs:
	...
	echo 1 > tracing_on
	cat trace_pipe
	Before removing the probe, echo 0 > events/probe_perf/__auxtrace_mmap__read/enable
\end{lstlisting}
