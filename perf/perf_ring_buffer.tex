...
\subsection*{The implementation for AUX ring buffer}

Below four callbacks in the structure \code{pmu} play important roles to manipulate the AUX ring buffer:
